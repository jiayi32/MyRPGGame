...
const drakehornForge: Lineage = {
  ...
  archetype: 'thermal',
  zodiac: 'nova',
  themeTags: ['thermal', 'burst', 'ramp', 'momentum'],
  adjacentLineageIds: ['tide_shell', 'thorn_ledger'],
  description:
    'Mega-corp specializing in plasma weaponry and stellar energy. Sacrifices defense for overwhelming thermal damage; overheat mechanics reward aggressive play.',
  uniqueMechanic: {
    id: 'heat',
    name: 'Heat Gauge',
    shortDescription:
      'Nova Dynamics specs accumulate Heat from basic attacks and DoTs, then vent it for amplified plasma bursts, HP-cost refunds, and cooldown resets.',
    evolutionByTier: {
  ...
  upgradeBonuses: [
    {
      rank: 1,
      effect: 'Thermal damage mastery — flat bonus to thermal-tagged damage output.',
      magnitude: UNSPECIFIED,
      magnitudeUnit: 'percent',
    },
    {
      rank: 2,
      effect: 'Burn duration extended on DoT effects applied by Nova Dynamics specs.',
      magnitude: UNSPECIFIED,
      magnitudeUnit: 'percent',
    },
    {
...
export const LINEAGES: readonly Lineage[] = [
  ...
  stubLineage(
    ...
    'defense',
    'bastion',
    ['defense', 'barrier', 'retaliation'],
    ['iron_covenant', 'arrow_creed'],
    'Defense mega-corp built on reactive barriers, fortification, and immovable presence.',
  ...
  stubLineage(
    ...
    'Black-ops network leveraging digital duplication and stealth misdirection; hub of the adjacency graph with Phantom Circuit branching from it.',
    twinMirrorMechanic,
  ),
  stubLineage(
    'tide_shell',
    ...
    'High-mobility corp specializing in phase-shift tech, CT manipulation, and unpredictable positioning.',
    tideShellMechanic,
  ),
  stubLineage(
    'sunfang_court',
    ...
    'radiant',
    'phoenix',
    ['radiance', 'precision', 'crit'],
    ['balance_reins', 'arrow_creed'],
    'Elite photonics corp. Precision laser tech, commanding field presence, devastating critical strikes.',
  ...
  stubLineage(
    ...
    'Bio-augmentation corp. Precision toxin delivery, nano-DoT stacking, inevitability through accumulation.',
    thornLedgerMechanic,
  ),
  stubLineage(
    'balance_reins',
    ...
    'Support corp using harmonic resonance tech. Team equalization, shared buffs, and sustained field operations.',
  ...
  stubLineage(
    ...
    'void',
    'wraith',
    ['stealth', 'assassination', 'ct-theft'],
    ['twin_mirror'],
    'Black-ops assassination network. Stealth tactics, digital elimination, and CT disruption. Branches from Umbral Net.',
    blackNestMechanic,
  ),
  stubLineage(
    'arrow_creed',
    ...
    'Military-industrial corp. Ballistic precision, disciplined formations, momentum-based kinetic impact.',
    arrowCreedMechanic,
  ),
  stubLineage(
    'iron_covenant',
    ...
    'kinetic',
    'juggernaut',
    ['contract', 'endurance', 'heavy'],
    ['dream_ocean', 'bull_cathedral'],
    'Mercenary collective bound by ironclad contracts. Heavy armor, steady sustain, overwhelming force projection.',
  ...
  stubLineage(
    ...
    'Quantum computing corp. CT manipulation, resource cycling, and battlefield tempo control at the code level.',
    starCircuitMechanic,
  ),
  stubLineage(
    'dream_ocean',
    ...
    'digital',
    'oracle',
    ['neural', 'illusion', 'heal', 'drone', 'reactive'],
    ['thorn_ledger', 'iron_covenant'],
    'Neural network corp. Holographic illusions, bio-repair nanites, and combat drone deployment. Reactive rather than proactive.',
    dreamOceanMechanic,
  ),
];

...
const styles = StyleSheet.create({
  ...
  classLabel: { fontSize: 12, color: '#889999', fontStyle: 'italic' },
  ...
  rulesTitle: { fontSize: 12, color: '#889999', fontWeight: '800', textTransform: 'uppercase' },
  rulesLine: { fontSize: 12, color: '#aabbcc' },
  graphScrollContent: {
  ...
  secondaryBtnText: { fontSize: 13, color: '#ffffff', fontWeight: '700' },
  backBtn: {

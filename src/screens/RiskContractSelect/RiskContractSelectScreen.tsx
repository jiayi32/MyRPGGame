...
const styles = StyleSheet.create({
  ...
  subtitle: { fontSize: 13, color: '#5d4d35', paddingHorizontal: 20, marginBottom: 8, lineHeight: 18 },
  ...
  cardName: { flex: 1, fontSize: 15, fontWeight: '700', color: '#2b1f10' },
  cardReward: { fontSize: 12, fontWeight: '700', color: '#7f5428' },
  cardDescription: { fontSize: 12.5, color: '#5f4d34', lineHeight: 17 },
  ...
  tagText: { fontSize: 10, fontWeight: '600', color: '#5d4d35' },
  footer: {
    padding: 20,
    borderTopWidth: 1,
  ...
  selectionHint: { fontSize: 12, color: '#7f6846', textAlign: 'center' },
});

...
const styles = StyleSheet.create({
  ...
  description: { fontSize: 13, color: '#ffffff', lineHeight: 19 },
  statsRow: {
    flexDirection: 'row',
    flexWrap: 'wrap',
    gap: 10,
  ...
  statLabel: { fontSize: 10, color: '#889999', textTransform: 'uppercase', letterSpacing: 0.5 },
  statValue: { fontSize: 13, color: '#ffffff', fontWeight: '600' },
  damageRangeCard: {
    borderWidth: 1,
    borderColor: 'rgba(0,255,255,0.1)',
    borderRadius: 8,
  ...
  damageRangeTitle: { fontSize: 11, color: '#889999', textTransform: 'uppercase', letterSpacing: 0.5, marginBottom: 4 },
  damageRangeText: { fontSize: 13, color: '#ffffff', fontWeight: '700' },
  damageRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingVertical: 2 },
  damageTierLabel: { fontSize: 12, color: '#aabbcc' },
  damageTierValue: { fontSize: 13, color: '#ffffff', fontWeight: '700' },
  damageCritValue: { color: '#b84a00' },
  damageRangeFootnote: { fontSize: 11, color: '#889999', marginTop: 4 },
  ...
  effectHeader: { fontSize: 12, color: '#ffffff', fontWeight: '700' },
  effectBody: { fontSize: 12, color: '#aabbcc', lineHeight: 17 },
  closeBtn: {
    alignSelf: 'center',
    backgroundColor: '#ffb000',
    borderRadius: 8,
